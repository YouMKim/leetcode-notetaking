...
Simple if you think about what its asking.
At every price point we just want to compare with minimum price we have seen BEFORE.
so we can always linearly explore forward and compare with current price
---
